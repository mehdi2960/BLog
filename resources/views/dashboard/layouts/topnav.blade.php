...
<header class="top-header-area d-flex align-items-center justify-content-between">
    <div class="left-side-content-area d-flex align-items-center">
        ...
        <div class="mobile-logo mr-3 mr-sm-4">
            <a href="master.blade.php"><img src="/admin/img/core-img/small-logo.png" alt="آرم موبایل"></a>
        </div>
    ...
    <div class="right-side-navbar d-flex align-items-center justify-content-end">
        ...
        <ul class="right-side-content d-flex align-items-center">
            ...
            <li class="nav-item dropdown">
                <button type="button" class="btn dropdown-toggle font-15 text-dark" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false">انگلیسی<i class="arrow_carrot-down"></i></button>
            ...
            <li class="nav-item dropdown">
                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                        aria-expanded="false"><img src="/admin/img/member-img/3.png" alt=""></button>
                <div class="dropdown-menu dropdown-menu-right">
                    <!-- User Profile Area -->
                    <div class="user-profile-area">
                        <div class="user-profile-heading">
                            ...
                            <div class="profile-img">
                                <img class="chat-img mr-2" src="/admin/img/member-img/3.png" alt="">
                            </div>
                            <!-- Profile Text -->
                        ...
                        <a href="#" class="dropdown-item"><i class="zmdi zmdi-account profile-icon bg-primary"
                        ...
                        <a href="#" class="dropdown-item"><i class="ti-unlink profile-icon bg-warning"
