    ...
    <div class="dashboard-area">
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="dashboard-content-right">
                                    ...
                                    <p class="font-15 font-weight-bold">شما امروز 65.6٪ <br>فروش بیشتر انجام داده
                                        اید .</p>
                                ...
                                <div class="dashboard-content-left wow shake" data-wow-delay="0.6s">
                                    <img src="img/bg-img/5.jpg" class="img-fluid" alt="داشبورد" width="180"
                                         height="180">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card  bg-c-blue">
                        <div class="card-body">
                            ...
                            <div class="earning-text mb-4">
                                <h3 class="mb-3">295.36 تومان <i class="feather icon-arrow-up teal accent-3"></i>
                                </h3>
                ...
                <!-- Single Widget -->
                <div
                    class="col-12 col-sm-6 col-lg-4 height-card box-margin break-992-none break-768-none break-576-none">
                    <div class="card">
                        <div class="card-body py-4">
                            <div class="media align-items-center">
                                <div class="d-inline-block mr-3">
                    ...
                    <div class="card bg-boxshadow full-height">
                        <div
                            ...
                            <ul class="nav total-earnings nav-tabs mb-0" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link show" id="today-users-tab" data-toggle="tab"
                                       href="#today-users" role="tab" aria-controls="today-users"
                                       aria-selected="false">امروز</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link mr-0 active" id="month-users-tab" data-toggle="tab"
                                       href="#month-users" role="tab" aria-controls="month-users"
                                       aria-selected="true">ماه</a>
                                </li>
                            </ul>
                        </div>
                                        ...
                                        <div class="media">
                                            <div class="mr-3">
                                                ...
                                                <a href="#!"><img class="rounded-circle" style="width:40px;"
                                                                  src="img/member-img/1.png" alt="کاربر چت"></a>
                                            </div>
                                            <div class="media-body">
                                ...
                                <div class="chats" id="chatBox">
                                    <div class="chats">
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p class="text-white">چطور میتوانیم کمک کنیم؟ ما برای شما اینجا
                                                        هستیم</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="chat">
                                            ...
                                            <div class="chat-body">
                                                <div class="chat-content">
                                                    <p class="text-white">Crest admin الگوی مدیریت پاسخگو bootstrap
                                                        4 است.</p>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <div class="row mb-3">
                                <div class="col-9">
                                    <div class="progress-wrapper">
                                            <span
                                                class="progress-label text-dark font-weight-bold">نشانه گذاری وب سایت</span>
                                        <div class="progress mt-2 mb-2" style="height: 5px;">
                                            <div class="progress-bar bg-primary" role="progressbar"
                        ...
                        <div class="card-body">
                            <div class="bg-transparent d-flex align-items-center justify-content-between mb-20">
                                ...
                                <div class="dashboard-dropdown">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" type="button" id="dashboardDropdown50"
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right"
                                            ...
                                            <a class="dropdown-item" href="#"><i class="ti-pencil-alt"></i> ویرایش
                                                کنید</a>
                ...
                <div class="col-md-6 col-xl-4 height-card box-margin">
                    <div class="card">
                        <div class="card-body pb-0">
                            <div
                                class="card-title bg-transparent d-flex align-items-center justify-content-between mb-20">
                                <div class="widgets-card-title">
                                ...
                                <div class="dashboard-dropdown">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" type="button" id="dashboardDropdown53"
                                                ...
                                                class="ti-more"></i></button>
                                        <div class="dropdown-menu dropdown-menu-right"
                                             aria-labelledby="dashboardDropdown53" x-placement="bottom-end"
                                             style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(30px, 30px, 0px);">
                                            <a class="dropdown-item" href="#"><i class="ti-pencil-alt"></i> ویرایش
                                                کنید</a>
                                            <a class="dropdown-item" href="#"><i class="ti-settings"></i>
                            ...
                            <div class="user-card-body">
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3" src="img/member-img/contact-1.jpg"
                                         alt="">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3" src="img/member-img/contact-2.jpg"
                                         alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3" src="img/member-img/contact-3.jpg"
                                         alt="">
                                    <div class="user--media-body">
                                ...
                                <div class="client-media-content d-flex align-items-center mb-4">
                                    <img class="client-thumb rounded-circle mr-3" src="img/member-img/contact-4.jpg"
                                         alt="">
                                    <div class="user--media-body">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right"><a href="#!"><i
                                                    class="fa fa-star f-18 text-warning"></i></a>
