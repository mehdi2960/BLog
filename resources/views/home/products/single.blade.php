                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="product-gallery default">
                                    <div class="zoomWrapper" style="height: 405.656px; width: 405.656px;">
                                        <img class="zoom-img" id="img-product-zoom" src="{{str_replace('public','/storage',$product->image)}}" data-zoom-image="{{str_replace('public','/storage',$product->image)}}" width="411" style="position: absolute;">
                                    </div>
                                    ...
                                    <div id="gallery_01f" style="width:500px;float:left;">
                                        <ul class="gallery-items">
                                            ...
                                            <li>
                                                <a href="tester" class="elevatezoom-gallery" data-image="assets/img/product/110197298.jpg" data-zoom-image="assets/img/product/110197298.jpg"><img src="assets/img/product/110197298.jpg" height="68"></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                          ...
                                                          <li>
                                                            <div class="comment-body">
                                                                <div class="comment-author">
                                                                    <img alt="" src="{{$comment->user>image ? $comment->user>image :''}}" class="avatar">
                                                                    <cite class="fn">
                                                                        {{$comment->user->name}}
                                                                    </cite>
